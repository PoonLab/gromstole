...
\node (wmut) [process, right of=waste, xshift=2.85cm, yshift=0.6cm, text width=2cm] {Mutation Counts};
...
\node (nsmut) [process, right of=nextstrain, xshift=1.66cm, text width=1.75cm, yshift=0.6cm] {Mutations in Variant of Interest};
\node (nsomi) [process, below of=nsmut, text width=1.75cm, yshift=-0.4cm] {Mutations in Other Variants};
\draw [arrow] (nextstrain) -- (nsmut);
\draw [thick, dashed,->,>=stealth] (nextstrain) -- (nsomi);
\draw [color=gray, thick](-1.15, -4.45) rectangle (3.8,-1.45);
